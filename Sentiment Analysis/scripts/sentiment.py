...
#Script built using code submitted to a Kaggle competition. The original submission can be found here:
#https://www.kaggle.com/code/thehemen/cnn-bilstm-russian-news-classifier
...
print(sub.head())
#Analaysis End (Taken from Kaggle code)